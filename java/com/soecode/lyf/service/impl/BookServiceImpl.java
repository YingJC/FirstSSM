...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public Book getById(long booId){
        return bookDao.queryById(booId);
    }
        ...
        try {
            ...
            if (update <= 0) {
                ...
                if (insert <= 0) {
                    ...
                    throw new RepeatAppoinException("repeat appoint");
                } else {
                    //预约成功
            ...
            //要先于catch, Exception异常前先catch住再抛出，不然自定义的异常也会被转换成AppointExcetion，导致控制层无法具体识别是哪个异常
